...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def show_bounding_box_from_annotation_file(self, file_path):
        # Guard: file_path can be None during initial directory import before any image is loaded
        if not file_path:
            return
    ...
    def change_save_dir_dialog(self, _value=False):
        ...
        # Only attempt to load annotations if an image is currently loaded
        if self.file_path:
            self.show_bounding_box_from_annotation_file(self.file_path)
    ...
    def open_dir_dialog(self, _value=False, dir_path=None, silent=False):
        ...
        # Set default_save_dir BEFORE importing, so autosave logic in open_next_image doesn't
        # trigger change_save_dir_dialog with self.file_path still None.
